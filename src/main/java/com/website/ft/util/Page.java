...
public class Page<T> {
	...
	private boolean needAutoPaging=true;// 是否系统插件分页？通过这个开关给业务代码自主权
...
//	}
	...
	public boolean isNeedAutoPaging() {
		return needAutoPaging;
	}

	public void setNeedAutoPaging(boolean needAutoPaging) {
		this.needAutoPaging = needAutoPaging;
	}
